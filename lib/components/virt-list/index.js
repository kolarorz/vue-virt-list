import { ref, shallowReactive, onBeforeMount, onMounted, onBeforeUnmount, onActivated, shallowRef, watch, defineComponent, isVue2 } from "vue-demi";
...
function useVirtList(userProps, emitFunction) {
  ...
  function getDefaultSize() {
    var _a, _b;
    return (_b = (_a = props.itemPreSize) != null ? _a : props.minSize) != null ? _b : 20;
  }
  function getItemSize(itemKey) {
    var _a;
    if (props.fixed)
      return getDefaultSize() + props.itemGap;
    return (_a = sizesMap.get(String(itemKey))) != null ? _a : getDefaultSize() + props.itemGap;
  }
  ...
  function calculateViewEnd(start) {
    var _a;
    const {
      itemKey
    } = props;
    ...
    for (let i = start; i < props.list.length; i++) {
      const itemSize = getItemSize((_a = props.list[i]) == null ? void 0 : _a[itemKey]);
  ...
  function calcListTotalSize() {
    var _a;
    if (props.fixed) {
      reactiveData.listTotalSize = (getDefaultSize() + props.itemGap) * props.list.length;
      return;
    }
    const {
      itemKey
  ...
  render() {
    ...
    const renderStickyHeaderSlot = () => {
      ...
      return getSlot(this, "stickyHeader") ? _h("div", {
        ...
        style: mergeStyles("position: sticky; z-index: 10;", horizontal ? "left: 0" : "top: 0;", stickyHeaderStyle),
    ...
    const renderStickyFooterSlot = () => {
      ...
      return getSlot(this, "stickyFooter") ? _h("div", {
        ...
        style: mergeStyles("position: sticky; z-index: 10;", horizontal ? "right: 0" : "bottom: 0;", stickyFooterStyle),
    ...
    const renderMainList = () => {
      ...
      for (let index = 0; index < renderList.length; index += 1) {
        ...
        mainList.push(_hChild(ObserverItem, {
          ...
          class: typeof itemClass === "function" ? itemClass(currentItem, index) : itemClass,
          style: mergeStyles(itemGap > 0 ? horizontal ? `padding: 0 ${itemGap / 2}px;` : `padding: ${itemGap / 2}px 0;` : "", typeof itemStyle === "function" ? itemStyle(currentItem, index) : itemStyle),
          attrs: {
