...
const useScrollbar = (
  ...
  const mergedOptions = computed(() => {
    return Object.assign({}, defaultProps.options, props.options);
  });
  ...
  const renderThumbStyle = (options: RenderThumbStyleParams) => {
    ...
    style.backgroundColor = mergedOptions.value.bgColor;
...
const VirtualScrollbar = defineComponent({
  ...
  render() {
    ...
    return _h(
      ...
      {
        style: trackStyle,
        class: `scrollbar-container ${mergedOptions.trackClass}`,
        attrs: {
          ref: 'trickRef',
      ...
      [
        _h('div', {
          class: `scrollbar-item ${mergedOptions.thumbClass}`,
          style: thumbStyle,
          attrs: {
            ref: 'thumbRef',
